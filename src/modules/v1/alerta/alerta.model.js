...
export const getAlerta= async (aleId) => {
    ...
    try{
        const query = 'SELECT * FROM usuario WHERE aleId = ?';
        let params = [
            aleId
        ];
...
export const insertAlerta = async (alerta) => {
    ...
    **/
    ...
    try{
        ...
        const query = 'INSERT INTO alerta(aleId, aleUsuario , aleUbi, aleEstado, aleFchEmision, aleFchCierre) VALUES (?, ?, ?, ?, ?, ?, ?)';
        let params = [
            alerta.idAlerta,
            alerta.usuarioEmisor,
            alerta.ubicacionAlerta,
            alerta.estadoAlerta,
            alerta.fechaEmision,
            alerta.fechaCierre,
        ];
